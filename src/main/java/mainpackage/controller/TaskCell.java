...
public class TaskCell extends JFXListCell<Task> {
        ...
        void initialize() {
                ...
                cellCheckbox.setOnMouseClicked(event -> {
                        ...
                        System.out.println("Task at index " + selectedIdx + (cellCheckbox.isSelected() ? " checked." : " unchecked."));
        ...
        protected void updateItem(Task task, boolean empty) {
                ...
                if (empty || task == null) {
                        ...
                        System.out.println("updateItem() | " + task.toString() + ", selected: " + task.getState()); // Nach Bugfix wieder löschen.
